...
export interface CadWorkspaceRoom {
  name: string
  polygon: CadWorkspacePoint[]
  bbox: CadWorkspaceBBox
  centroid: CadWorkspacePoint
  width: number
  height: number
  area: number
...
export interface CadWorkspaceFitSummary {
...
export interface CadWorkspaceExtractResult {
  ...
  fit_summary?: CadWorkspaceFitSummary | null
  warnings: string[]
}

export interface CadReviewExportState {
  ready: boolean
  href?: string
  reason?: string
}

export interface CadReviewArtifactData {
  analysisId: string
  sourceName: string
  canonicalUnit: string
  floorPlan: CadWorkspaceView
  sitePlan: CadWorkspaceView
  fitSummary: CadWorkspaceFitSummary | null
  warnings: string[]
  export: CadReviewExportState
}
