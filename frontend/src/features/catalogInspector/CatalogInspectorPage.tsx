...
export function CatalogInspectorPage({ topology }: CatalogInspectorPageProps) {
  ...
  const supportBoundaryCount = boundaries.filter((boundary) => boundary.boundary_kind === 'support').length
      ...
      <header className="border-b border-white/6 bg-zinc-950/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          ...
          <div className="grid gap-3 sm:grid-cols-11">
            ...
            <div className="rounded-2xl border border-white/6 bg-white/[0.03] px-4 py-3">
              <p className="text-[11px] uppercase tracking-[0.22em] text-zinc-600">Support boundaries</p>
              <p className="mt-1 text-lg font-semibold text-violet-200">{supportBoundaryCount}</p>
            </div>
            <div className="rounded-2xl border border-white/6 bg-white/[0.03] px-4 py-3">
            ...
            <div className="rounded-2xl border border-white/6 bg-white/[0.03] px-4 py-3">
              <p className="text-[11px] uppercase tracking-[0.22em] text-zinc-600">Artifact boundaries</p>
              <p className="mt-1 text-lg font-semibold text-orange-300">{artifactBoundaryCount}</p>
            </div>
            <div className="rounded-2xl border border-white/6 bg-white/[0.03] px-4 py-3">
